...
def generate_page(filename, data):
    ...
    # Surgical Header/Title replacements
    ...
    # Replace the whole block inside pxn_service_content
    # Note: Using a very specific regex to match the inner content of the div
    content = re.sub(r'<div class="pxn_service_content">.*?</div>\s*</div>\s*</div>', f'<div class="pxn_service_content">{new_service_content}\n                </div>\n              </div>', content, flags=re.DOTALL)
    ...
    content = re.sub(r'<aside class="pxn_sidebar">.*?</aside>', f'<aside class="pxn_sidebar">{new_sidebar}\n                </aside>', content, flags=re.DOTALL)
...
print("All service pages fixed and re-generated correctly.")
