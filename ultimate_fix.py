...
for filename in all_html_files:
    ...
    c = re.sub(r'<div class="pxn_video[^"]*">.*?</div>', '', c, flags=re.DOTALL)
    # Remove video_popup links
    c = re.sub(r'<a[^>]*class="[^"]*video_popup[^"]*"[^>]*>.*?</a>', '', c, flags=re.DOTALL)
    # Remove play icons
    c = c.replace('<i class="pxni-play"></i>', '')
    with open(filepath, 'w', encoding='utf-8') as f:
        f.write(c)

# 2. Perfect Service Page Generation (No Video, Correct Layout)
services_data = {
    "strategic-planning.html": {
        ...
        "main_img": "https://images.unsplash.com/photo-1552664730-d307ca884978?w=1000",
        "second_img": "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1000"
    },
    "digital-transformation.html": {
        ...
        "main_img": "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1000",
        "second_img": "https://images.unsplash.com/photo-1518770660439-4636190af475?w=1000"
    },
    "risk-management.html": {
        ...
        "main_img": "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=1000",
        "second_img": "https://images.unsplash.com/photo-1454165833767-027eeef1593e?w=1000"
    },
    "business-process.html": {
        ...
        "main_img": "https://images.unsplash.com/photo-1454165833767-027eeef1593e?w=1000",
        "second_img": "https://images.unsplash.com/photo-1517245327032-9792f6895c02?w=1000"
    },
    "financial-management.html": {
        ...
        "main_img": "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=1000",
        "second_img": "https://images.unsplash.com/photo-1554224155-169745fe9a5c?w=1000"
    },
    "market-research.html": {
        ...
        "main_img": "https://images.unsplash.com/photo-1517245327032-9792f6895c02?w=1000",
        "second_img": "https://images.unsplash.com/photo-1551288049-bbbda536339a?w=1000"
    },
    "business-optimization.html": {
        ...
        "main_img": "https://images.unsplash.com/photo-1517245327032-9792f6895c02?w=1000",
        "second_img": "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=1000"
    },
    "it-consulting.html": {
        "title": "IT Consulting",
        ...
        "main_img": "https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=1000",
        "second_img": "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=1000"
    },
    "change-management.html": {
        ...
        "main_img": "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1000",
        "second_img": "https://images.unsplash.com/photo-1517245327032-9792f6895c02?w=1000"
    },
    "leadership.html": {
        "title": "Leadership",
        ...
        "main_img": "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=1000",
        "second_img": "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1000"
    },
    "growth-expansion.html": {
        ...
        "main_img": "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1000",
        "second_img": "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=1000"
    }
}

def build_final(filename, data):
...
'''
    ...
    if start_idx != -1 and end_idx != -1:
        content = content[:start_idx] + new_service_content + content[end_idx:]
    ...
    new_sidebar = f'''
                <aside class="pxn_sidebar">
                  <div class="pxn_sidebar_widget">
                    ...
                    <ul class="pxn_services_list">{sidebar_links}
                    </ul>
                  </div>

                  <div class="pxn_sidebar_widget">
                    <h2 class="sidebar_title">Get a Quote</h2>
                    <form action="index.html" class="pxn_get_quote">
                      <input type="text" name="fname" id="fname" placeholder="Name...">
                      <input type="email" name="email" id="email" placeholder="Email...">
                      <input type="tel" name="phone" id="phone" placeholder="Phone...">
                      <button type="submit" class="quote_btn pxn-btn-primary w-100">
                        <span class="btn_text"><span>Submit Request</span></span>
...
'''
    s_start = '<aside class="pxn_sidebar">'
    s_end = '</aside>'
    ss_idx = content.find(s_start)
    se_idx = content.find(s_end) + len(s_end)
    if ss_idx != -1 and se_idx != -1:
        content = content[:ss_idx] + new_sidebar_html if 'new_sidebar_html' in locals() else content[:ss_idx] + new_sidebar + content[se_idx:]
...
for filename, data in services_data.items():
    page_html = build_final(filename, data)
    with open(os.path.join(directory, filename), 'w', encoding='utf-8') as f:
        f.write(page_html)

print("Final cleanup and absolute service page generation complete.")
